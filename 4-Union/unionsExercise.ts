...
let numbersArrays: number[] = [1, 2, 3, 4, 5];
let stringsArrays: string[] = ["yetkin", "cemile", "şeref"];
let stuff: (number | string)[] = [1, 2, 3, 4, 5, "yetkin", "cemile", "şeref"];
// **********************************************
// ******************* PART 3 *******************
// **********************************************
...
type SkiSchoolStudent = {
  ...
  age: number;
  sport: "ski" | "snowboard";
  level: SkillLevel; // Remove the 'typeof' keyword
};
// **********************************************
// ******************* PART 5 *******************
// **********************************************
...
let names: string[] = ["Yetkin", "Cemile", "Şeref"];
console.log(greet("Yetkin"));
